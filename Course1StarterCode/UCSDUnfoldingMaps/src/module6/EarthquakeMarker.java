 ...
 *
 */
// Implement the comparable interface so earthquakes can be sorted by magnitude
	...
	implements Comparable<EarthquakeMarker>
{
	...
	/** Compare earthquakes by magnitude, highest magnitude first.
	 * This is "reverse" natural order on magnitude, so that sorting an
	 * array/list of EarthquakeMarkers puts the strongest quakes at the front.
	 */
	public int compareTo(EarthquakeMarker marker)
	{
		// Reverse order: the marker with the LARGER magnitude should come first.
	...
	/** Accessor for the "age" property of this earthquake
	 * (e.g. "Past Hour", "Past Day", "Past Week").
	 * @return the age string, or null if it was not set.
	 */
